 ...
 * Powered by LeafletExploreMap with dual tile support (Road & Satellite).
 */
...
import LeafletExploreMap from '../../components/LeafletExploreMap';
  ...
  return (
    <View className="flex-1 bg-background relative">
      ...
      <LeafletExploreMap
        ...
        onDeselect={() => setSelectedReport(null)}
      />
